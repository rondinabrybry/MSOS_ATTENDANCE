...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-4 flex justify-center items-center w-full bg-red-200 dark:bg-gray-700" style="background-color: rgb(148, 49, 49);">
        <div id="currentTime" class="text-7xl font-bold text-gray-900 text-white dark:text-gray-100 tracking-widest"></div>
    </div>
        ...
        <div class="w-auto max-w-xs sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    <p class="text-xl text-gray-900 dark:text-gray-200">Scan your ID</p>
                    <div class="mt-6">
                ...
                <div class="p-6 bg-white dark:bg-gray-800">
                    <div id="userDetails" class="mt-6 p-4 bg-gray-100 rounded-md hidden flex items-start">
                        ...
                        <div id="userInfo" class="ml-4">
                            ...
                            <div class="flex flex-col time_box w-full bg-red-100 p-6 rounded-lg flex justify-center items-center h-48">
                                <p class="text-6xl text-center font-semibold text-red-800">
                                    <?php echo e($currentDateTime->format('M d Y')); ?>

                                </p>
                                <p id="timein" class="text-8xl text-center font-semibold text-red-800">
...
<script>
    ...
    <script>
                ...
                if (idNumber) {
                    fetch(`/fetch-user-details/${idNumber}`)
                        ...
                        .then(data => {
                            ...
                            fetch("<?php echo e(route('logAttendance.store')); ?>", {
                                method: 'POST',
                                headers: {
        ...
        document.getElementById('logoutButton').addEventListener('click', function() {
            fetch("<?php echo e(route('unsetSessionLogout')); ?>", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\LARAVEL\ATTENDANCE\ATTENDANCE\resources\views/session-window-logout.blade.php ENDPATH**/ ?>