        ...
        <div class="content" style="display:none;">
            ...
            <?php $__currentLoopData = $courseGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $records): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-6">
                    ...
                    <div class="content" style="display:none;">
                        <!-- Print Button for Each Date-Group Combination -->
                        ...
                        <!-- Attendance Table for Date-Group Combination -->
...
<script>
    function printGroup(formattedDate, group) {
        ...
        printWindow.document.write('<html><head><title><?php echo e($group); ?></title>');
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\LARAVEL\ATTENDANCE - Copy\ATTENDANCE\resources\views/admin/attendance_history.blade.php ENDPATH**/ ?>