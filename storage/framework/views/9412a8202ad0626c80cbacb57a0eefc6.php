<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            <?php echo e(__('Delete Account')); ?> (<span style="color: red;">Only Admins can see this.</span>)
        </h2>
...
<?php /**PATH C:\xampp\htdocs\LARAVEL\ATTENDANCE\ATTENDANCE\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>