...
<body>
    <header>
        <div class="wrapHead">
            <img src="{{ asset('public/storage/logo.png') }}" alt="MSOS" class="brand-logo">
            <nav>
                <ul>
    ...
    <div class="snap">
        <!-- Hero Section -->
        <section id="hero" class="section hero" style="background-image: url('{{ asset('images/bg.png') }}'); background-size: cover; background-position: center;">
            <div class="adjust">
                <div class="hero-header">
                    <img src="{{ asset('storage/logo.png') }}" alt="MSOS" class="logo">
        ...
        <!-- Features Section -->
        <section id="features" class="section features-section" style="background-image: url('{{ asset('images/bg.png') }}'); background-size: cover; background-position: center;">
            <div class="container">
                ...
                <div class="flex">
                    ...
                    <div class="feature-item hover-grow">
                        <a href="{{ url('/') }}" target="_blank">
                            <img src="{{ asset('images/online2.png') }}" alt="Online Bulletin">
                        </a>
        ...
        <section id="testimonials" class="section testimonials-section bg-black flex flex-col items-center justify-center min-h-screen" style="background-image: url('{{ asset('images/bg.png') }}'); background-size: cover; background-position: center;">
            <div class="text-center mb-8 p-5">
               ...
               <div class="relative flex space-x-0">
                <div class="image-slice">
                 <img alt="First slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/mark.png') }}" width="100"/>
                 <div class="overlay-text">Mark</div>
                 <div class="role-text">Full-Stack Dev</div>
                </div>
                <div class="divider"></div>
                <div class="image-slice">
                 <img alt="Second slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/bry.png') }}" width="100"/>
                 <div class="overlay-text">Ken</div>
                 <div class="role-text">Full-Stack Dev</div>
                </div>                
                <div class="divider"></div>
                <div class="image-slice">
                 <img alt="Fourth slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/nat.png') }}" width="100"/>
                 <div class="overlay-text">Nathan</div>
                 <div class="role-text">Manager</div>
                </div>
                <div class="divider"></div>
                <div class="image-slice">
                 <img alt="Third slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/john.png') }}" width="100"/>
                 <div class="overlay-text">John</div>
                 <div class="role-text">Docs</div>
                </div>
                <div class="divider"></div>
                <div class="image-slice">
                 <img alt="Fifth slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/vin.png') }}" width="100"/>
                 <div class="overlay-text">Vin</div>
                 <div class="role-text">Docs</div>
                </div>
                <div class="divider"></div>
                <div class="image-slice">
                 <img alt="Fifth slice of a man's face with transparent background" class="w-48 h-72 object-cover" height="200" src="{{ asset('dev/scot.png') }}" width="100"/>
        ...
        <!-- Call to Action Section -->
        <section id="cta" class="section cta-section" style="background-image: url('{{ asset('images/bg.png') }}'); background-size: cover; background-position: center;">
            <div class="content-container">
                ...
                <div class="download-section">
                    ...
                    <div class="download-buttons">
                        <a href="{{ url('/download') }}">
                        <img src="{{ asset('images/download.png') }}" alt="download app" >
                        </a>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <p>&copy; {{ date('Y') }} MSOS. All rights reserved.</p>
    </footer>
